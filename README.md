...
To do this, first copy `src/config/auth.json.example` into a new file in the same folder called `src/config/auth.json`, and replace the values with your own Auth0 application credentials, and optionally the base URLs of your application and API:
